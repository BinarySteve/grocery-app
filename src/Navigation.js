...
import { Collapse, Navbar, NavbarToggler, NavbarBrand, NavbarText, Nav, NavItem, NavLink } from 'reactstrap';
...
const Navigation = (props) => {
	...
	return (
		<Navbar className="" color="dark" dark expand="md">
			<NavbarBrand onClick={toggle} tag={Link} to="/">
				Chavez Family Grocery Tracker
			</NavbarBrand>
			<NavbarToggler onClick={toggle} />
			<Collapse isOpen={navToggle} navbar>
				<Nav className="mr-auto" navbar>
					{user && <NavbarText className="mr-3  text-white">Hi, {user.displayName}</NavbarText>}
					<NavItem>
